...
public class BCFController : MonoBehaviour {

    public static BCFController instance;
    ...
    public class LAYER {
        ...
        public void TransitionToTexture(Texture texture, float speed = 1f, bool smooth = false) {
            ...
            StopTransitioning();
            transitioning = BCFController.instance.StartCoroutine(Transitioning(texture, speed, smooth));
        }

        void StopTransitioning() {
            if (isTransitioning) {
                BCFController.instance.StopCoroutine(transitioning);
            }
            transitioning = null;
        }
